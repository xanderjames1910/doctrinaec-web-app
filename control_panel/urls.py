...
urlpatterns = [
    ...
    path('newsletter-list/', control_newsletter_list,
         name='control_newsletter_list'),
    path('newsletter-detail/<int:pk>', control_newsletter_detail,
         name='control_newsletter_detail'),
    path('newsletter-edit/<int:pk>', control_newsletter_edit,
         name='control_newsletter_edit'),
    path('newsletter-delete/<int:pk>', control_newsletter_delete,
